...
class BookController {
    constructor() {
        ...
        this.getAllBooks = (0, catchAsync_1.default)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.getBook = (0, catchAsync_1.default)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.createBook = (0, catchAsync_1.default)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.updateBook = (0, catchAsync_1.default)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const book = yield bookModel_1.Book.findByIdAndUpdate(req.params.id, req.body, {
                new: true,
                runValidators: true
            });
            if (!book) {
        ...
        this.deleteBook = (0, catchAsync_1.default)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.resizeCoverPhoto = (0, catchAsync_1.default)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.updateCoverPhoto = (0, catchAsync_1.default)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            ...
            if (!photo ||
                ...
                return next(new appError_1.AppError('This route is solely for Cover photo update. Please use an alternative route', 400));
            }
            const updatedBook = yield bookModel_1.Book.findByIdAndUpdate(req.params.id, { photo: photo }, {
                new: true,
                runValidators: true
            });
            res.status(200).json({
